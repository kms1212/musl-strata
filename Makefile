...
EMPTY_LIBS = $(EMPTY_LIB_NAMES:%=lib/lib%.sl)
...
LDSO_PATHNAME = $(syslibdir)/ld-musl-$(ARCH)$(SUBARCH).dl.1
...
$(DESTDIR)$(LDSO_PATHNAME): $(DESTDIR)$(libdir)/libc.dl
	$(INSTALL) -D -l $(libdir)/libc.dl $@ || true
